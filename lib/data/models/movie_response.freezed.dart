...
class _MovieResponse implements MovieResponse {
  const _MovieResponse({required this.page, required final  List<MovieResults> results, @JsonKey(name: 'total_pages') required this.totalPages, @JsonKey(name: 'total_results') required this.totalResults}): _results = results;
