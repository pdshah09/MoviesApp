...
_MovieConfiguration _$MovieConfigurationFromJson(Map<String, dynamic> json) =>
    _MovieConfiguration(
...
Map<String, dynamic> _$MovieConfigurationToJson(_MovieConfiguration instance) =>
    <String, dynamic>{
      'images': instance.images,
      'change_keys': instance.changeKeys,
    };

_MovieConfigurationImages _$MovieConfigurationImagesFromJson(
...
Map<String, dynamic> _$MovieConfigurationImagesToJson(
  _MovieConfigurationImages instance,
) => <String, dynamic>{
